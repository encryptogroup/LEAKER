...
from leaker.evaluation.evaluator import ErrorSimulationRelationalAttackEvaluator, KeywordAttackEvaluator
...
out_file = "scoring+ref_error_simulation_100k_11cols_5x5_25%kdr_gaussian_scale_0.1.png"  # Output file (if desired), will be stored in data/figures

error_rates = [1, 1.05, 1.1, 1.15, 1.2, 1.25, 1.3, 1.35, 1.4, 1.45, 1.5, 1.55, 1.6, 1.65, 1.7, 1.75, 1.8, 1.85, 1.9, 1.95, 2]
...
eva = ErrorSimulationRelationalAttackEvaluator(evaluation_case=evaluation_case, dataset_sampler=dataset_sampler,
                                               ...
                                               parallelism=2, error_rates=error_rates)

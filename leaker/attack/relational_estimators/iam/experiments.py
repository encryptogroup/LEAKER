...
EXPERIMENT_CONFIGS = {
    ...
    'job-light-ranges-mm': dict(
        dict(dict(BASE_CONFIG, **JOB_LIGHT_BASE), **FACTORIZE),
        **{
            'queries_csv': './queries/job-light-ranges_mm_wisdm.csv',
            'use_cols': 'content',
...
TEST_CONFIGS['test-higss'] = dict(
    EXPERIMENT_CONFIGS['higss'],
    **{
        'queries_csv': './queries/higss_query',
        'epochs': 10,
        'asserts': {
...
TEST_CONFIGS['test-twitter'] = dict(
    EXPERIMENT_CONFIGS['twitter'],
    **{
        'queries_csv': './queries/twitter_query',
        'epochs': 10,
        'asserts': {
            'fact_psample_8000_median': 4,
            'fact_psample_8000_p99': 50,
...
TEST_CONFIGS['test-wisdm'] = dict(
    EXPERIMENT_CONFIGS['wisdm'],
    **{
        'queries_csv': './queries/wisdm_query',
        'epochs': 10,
        'asserts': {
            'fact_psample_8000_median': 4,
            'fact_psample_8000_p99': 50,
...
TEST_CONFIGS['test-job-light-mm'] = dict(
    EXPERIMENT_CONFIGS['job-light-mm'],
    **{
        # Train for a bit and checks that these metrics are reasonable.
        'queries_csv': './queries/job-light_mm_wisdm',
        'epochs': 7,
        'asserts': {
            'fact_psample_8000_median': 4,
            'fact_psample_8000_p99': 50,
...
TEST_CONFIGS['test-job-light-ranges-mm'] = dict(
    EXPERIMENT_CONFIGS['job-light-ranges-mm'],
    **{
        # Train for a bit and checks that these metrics are reasonable.
        'queries_csv': './queries/job-light-ranges_mm_wisdm',
        'epochs': 10,
        'asserts': {
            'fact_psample_8000_median': 4,
            'fact_psample_8000_p99': 50,
...
TEST_CONFIGS['higss-reload'] = dict(
    EXPERIMENT_CONFIGS['higss'], **{
        'queries_csv': './queries/higss_query',
        'checkpoint_to_load': tune.grid_search([
            'models/higss-pretrained-7.pt',
        ]),
        'eval_psamples': [8000],
        'asserts': {
...
TEST_CONFIGS['higss-naru-reload'] = dict(
    EXPERIMENT_CONFIGS['higss'], **{
        'queries_csv': './queries/higss_query',
        'checkpoint_to_load': tune.grid_search([
            'models/higss-naru-pretrained-7.pt',
        ]),
        'eval_psamples': [8000],
        'asserts': {
            'fact_psample_512_median': 1.7,
...
TEST_CONFIGS['wisdm-reload'] = dict(
    EXPERIMENT_CONFIGS['higss'], **{
        'queries_csv': './queries/wisdm_query',
        'checkpoint_to_load': tune.grid_search([
            'models/wisdm-pretrained-7.pt',
        ]),
        'eval_psamples': [8000],
        'asserts': {
            'fact_psample_512_median': 1.7,
...
TEST_CONFIGS['wisdm-naru-reload'] = dict(
    EXPERIMENT_CONFIGS['higss'], **{
        'queries_csv': './queries/wisdm_query',
        'checkpoint_to_load': tune.grid_search([
            'models/wisdm-naru-pretrained-7.pt',
        ]),
        'eval_psamples': [8000],
        'asserts': {
            'fact_psample_512_median': 1.7,
...
TEST_CONFIGS['twitter-reload'] = dict(
    EXPERIMENT_CONFIGS['twitter'], **{
        'queries_csv': './queries/twitter_query',
        'checkpoint_to_load': tune.grid_search([
            'models/twitter-pretrained-7.pt',
        ]),
        'eval_psamples': [8000],
        'asserts': {
            'fact_psample_512_median': 1.7,
...
TEST_CONFIGS['twitter-naru-reload'] = dict(
    EXPERIMENT_CONFIGS['twitter'], **{
        'queries_csv': './queries/twitter_query',
        'checkpoint_to_load': tune.grid_search([
            'models/twitter-naru-pretrained-7.pt',
        ]),
        'eval_psamples': [8000],
        'asserts': {
            'fact_psample_512_median': 1.7,
...
TEST_CONFIGS['job-light-mm-naru-reload'] = dict(
    EXPERIMENT_CONFIGS['job-light-mm'], **{
        'queries_csv': './queries/job-light_mm_wisdm',
        'save_checkpoint_at_end': False,
        'checkpoint_to_load': tune.grid_search([
            'models/job-light-mm-naru-pretrained-7.pt',
        ]),
        'eval_psamples': [8000],
        'asserts': {
            'fact_psample_512_median': 1.7,
...
TEST_CONFIGS['job-light-mm-reload'] = dict(
    EXPERIMENT_CONFIGS['job-light-mm'], **{
        'queries_csv': './queries/job-light_mm_wisdm',
        'save_checkpoint_at_end': False,
        'checkpoint_to_load': tune.grid_search([
            'models/job-light-mm-pretrained-7.pt',
        ]),
        'eval_psamples': [8000],
        'asserts': {
            'fact_psample_512_median': 1.7,
...
TEST_CONFIGS['job-light-mm-sub-naru-reload'] = dict(
    EXPERIMENT_CONFIGS['job-light-mm'], **{
        'queries_csv': './queries/job-light_mm_wisdm_subquery',
        'save_checkpoint_at_end': False,
        'checkpoint_to_load': tune.grid_search([
            'models/job-light-mm-naru-pretrained-7.pt',
        ]),
...
TEST_CONFIGS['job-light-mm-sub-reload'] = dict(
    EXPERIMENT_CONFIGS['job-light-mm'], **{
        'queries_csv': './queries/job-light_mm_wisdm_subquery',
        'save_checkpoint_at_end': False,
        'checkpoint_to_load': tune.grid_search([
...
TEST_CONFIGS['job-light-ranges-mm-naru-reload'] = dict(
    EXPERIMENT_CONFIGS['job-light-ranges-mm'], **{
        'queries_csv': './queries/job-light-ranges_mm_wisdm',
        'save_checkpoint_at_end': False,
        'checkpoint_to_load': tune.grid_search([
            'models/job-light-ranges-mm-naru-pretrained-7.pt',
        ]),
        'eval_psamples': [8000],
        'asserts': {
            'fact_psample_512_median': 1.7,
...
TEST_CONFIGS['job-light-ranges-mm-postgres'] = dict(
    EXPERIMENT_CONFIGS['job-light-ranges-mm'], **{
        'queries_csv': './queries/job-light-ranges_mm_wisdm_deepdb.csv',
        'save_checkpoint_at_end': False,
        'checkpoint_to_load': tune.grid_search([
            'models/job-light-ranges-mm-naru-pretrained-7.pt',
        ]),
...
TEST_CONFIGS['job-light-ranges-mm-reload'] = dict(
    EXPERIMENT_CONFIGS['job-light-ranges-mm'], **{
        'queries_csv': './queries/job-light-ranges_mm_wisdm',
        'save_checkpoint_at_end': False,
        'checkpoint_to_load': tune.grid_search([
            'models/job-light-ranges-mm-reload',
        ]),
        'eval_psamples': [8000],
        'asserts': {
            'fact_psample_512_median': 1.7,
...
TEST_CONFIGS['job-light-ranges-mm-sub-naru-reload'] = dict(
    EXPERIMENT_CONFIGS['job-light-ranges-mm'], **{
        'queries_csv': './queries/job-light-ranges_mm_wisdm_subquery',
        'save_checkpoint_at_end': False,
        'checkpoint_to_load': tune.grid_search([
            'models/job-light-ranges-mm-naru-pretrained-7.pt',
        ]),
...
TEST_CONFIGS['job-light-ranges-mm-sub-reload'] = dict(
    EXPERIMENT_CONFIGS['job-light-ranges-mm'], **{
        'queries_csv': './queries/job-light-ranges_mm_wisdm_subquery',
        'save_checkpoint_at_end': False,
        'checkpoint_to_load': tune.grid_search([
            'models/job-light-ranges-mm-pretrained-7.pt',
        ]),
        'eval_psamples': [8000],
        'asserts': {
            'fact_psample_512_median': 1.7,

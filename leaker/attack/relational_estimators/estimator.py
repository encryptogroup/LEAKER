...
from .iam.common import Table, CsvTable, TableDataset
from .iam.estimators import ProgressiveSampling, CardEst
from .iam.run import MakeMade, transformer, run_epoch
from .iam.train_utils import ReportModel, weight_init, get_device
class IamRelationalEstimator(RelationalEstimator):
    """Uses the IAM estimator: https://github.com/mzz235711/IAM"""
    ...
    def _train(self) -> None:
        ...
        for table_name in self._dataset_sample.tables():
            ...
            model = MakeMade(table=table, scale=256, layers=4, cols_to_train=table.columns, seed=None)  # TODO: adjust scale and layers
